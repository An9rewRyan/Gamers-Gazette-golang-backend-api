...
func Me(w http.ResponseWriter, r *http.Request) {
	...
	url = fmt.Sprintf("https://api.vk.com/method/users.get?&access_token=%s&fields=%s&user_ids=%s&v=5.131", gjson.Get(string(bytes), "access_token"), scopeTemp, gjson.Get(string(bytes), "user_id"))
	fmt.Println(url)
